...
- **동물상 커뮤니티:** 익명으로 닉네임과 비밀번호를 설정하여 글을 남기고 실시간으로 소통할 수 있습니다. (New)
...
- **반응형 디자인:** 모바일과 데스크톱 모두에서 최적화된 UI를 제공합니다. 모바일 화면에서의 답답함을 해소하기 위해 카드 여백, 타이틀 크기, 요소 간 간격을 최적화하였습니다. 또한 '가이드', '커뮤니티' 네비게이션 클릭 시 스크롤 위치를 정확하게 보정하여 제목이 잘리지 않도록 개선하였습니다. (Improved)
